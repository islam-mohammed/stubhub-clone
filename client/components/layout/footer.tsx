...
interface NavLink {
  name: string;
  href: string;
  icon?: (props: AppProps) => JSX.Element;
}
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            {navigation.social.map((item: NavLink) => (
              <a
                key={item.name}
                href={item.href}
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; {new Date().getFullYear()} Stub Hub, Inc. All rights
            reserved. Use of this website signifies your agreement to our User
            Agreement, Privacy Notice and Cookie Notice. You are buying tickets
            from a third party; StubHub is not the ticket seller. Prices are set
            by sellers and may be above face value. User Agreement change
            notifications
          </p>
        </div>
      </div>
